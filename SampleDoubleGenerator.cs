...
namespace iot_emulator
{
        ...
        /// </summary>
        public class SampleDoubleGenerator
        {
            ...
            public SampleDoubleGenerator(double minValueToGenerate,
            ...
            public SampleDoubleGenerator(double minValueToGenerate, double maxNonPeakValueToGenerate)
                : this(minValueToGenerate, maxNonPeakValueToGenerate, 0, 0, new RandomDouble())
            {
            }
